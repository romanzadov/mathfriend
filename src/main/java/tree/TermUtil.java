...
public class TermUtil {
	...
	private static Term getOverEqualsSibling(Term start, Term end) {
		if (start != null) {
			if (start.getParent() != null && Function.EQUALS.equals(start.getParent().getFunction())) {
				return getSibling(start, end);
			} else if (start.getParent() != null  && start.getParent().getParent() != null  &&
					Function.EQUALS.equals(start.getParent().getParent().getFunction())) {
	...
	private static Term getSibling(Term self, Term relative) {
		...
		if (relative != null && self != null && relative.getParent() != null) {
